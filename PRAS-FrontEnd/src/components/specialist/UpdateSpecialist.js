...
export default class updateSpecialist extends Component {
    render() {
        return (
            <div>
                <Row>
                    <Col sm="12" md={{ size: 6, offset: 3 }}>
                        <Form>
                            <br></br>
                            <h3 className="specialistDetail" align="center">Update Specialist Details</h3>
                            <FormGroup row>
                            ...
                            <FormGroup check row>
                                <Col sm="12" md={{ size: 6, offset: 3 }}>
                                    <Button color="warning" >Edit Specialist</Button>
                                </Col>
                            </FormGroup>
                        </Form>
                    </Col>
