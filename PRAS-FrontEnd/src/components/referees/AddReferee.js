...
export default class AddReferee extends Component {
    render() {
        return (
            <div>
                <Row>
                    <Col sm="12" md={{ size: 6, offset: 3 }}>
                        <Form>
                            <br></br>
                            <h3 className="refereeDetail" align="center">Project Referee Details</h3>
                            <FormGroup row>
                            ...
                            <FormGroup check row>
                                <Col sm="12" md={{ size: 6, offset: 3 }}>
                                    <Button color="success">Add Referee</Button>
                                </Col>
                            </FormGroup>
                        </Form>
                    </Col>
